...
.source.python .variable.parameter {
  ...
  <body class='markdown-preview'><h1 id="micro-twitter-blog">Micro Twitter Blog</h1>
<p>&quot;Our Project Name&quot; is a social networking clone project. Built initially as a static site, &quot;Our Project Name&quot; 
is a front end experience to (fill in)</p>
<h2 id="requirements-and-technologies">Requirements and Technologies</h2>
<ul>
<li>Working in teams/partners</li>
<li>quality based front end</li>
<li>In depth understanding of HTTP</li>
<li>Relationship between front-end and back-end</li>
<li></li>
</ul>
<ul>
<li><a href="https://validator.w3.org">W3C Validator</a></li>
<li>Text editor <a href="https://Brackets.io">Brackets</a></li>
<li><a href="https:github.com">Github</a> and <a href="https://pages.github.com/">github pages</a></li>
</ul>
<h2 id="how-to-install-and-run">How to Install and Run</h2>
<ol>
<li>Clone repository ()</li>
<li>Open files in text editor or web browser.</li>
<li></li>
</ol>
<h2 id="process">Process</h2>
<p><img src="https://" alt="Data modeling"></p></body>
</html>
